         ...
         @csrf
                ...
                Let's start with the basics
                    ...
                    <label for="Default select example" style="font-size: large">I am a ... ?</label>
                        ...
                        <label for="Default select example2" style="font-size: large">Who are you crowdfunding for? </label>
...
<br>
           ...
           <label for="title" style="font-size: large; margin:13px">Full Name of Person of Concern</label>
...
<br>
           ...
           <label for="Default select example" style="font-size: large">Doctor's Report</label>
           <div class="mb-5" style="border-style: dashed">
            <div class="my-3 px-3 text-center">
