        ...
        <div class="row mt-5 pt-2">
            ...
            <form action="{{route('store-campaign')}}" method="post" id="regForm" enctype="multipart/form-data">
                ...
                Set your fundraising goal
                    ...
                    <input type="text" min="200" oninput="validity.valid||(value='');" name="target" id="inputdetail2" placeholder="Enter Target Amount in GHC" class="form-control" aria-describedby="passwordHelpBlock">
                    <div id="passwordHelpBlock" class="form-text mb-4">
           ...
           <input oninput="this.className = 'form-control'" name="full_name" type="text" placeholder="Enter your name" id="inputdetail3"  class="form-control mb-5" aria-describedby="passwordHelpBlock">
<br>
