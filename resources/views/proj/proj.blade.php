        ...
        <div class="row mt-5 pt-2">
            ...
            <label for="Default select example" style="font-size: large"><b>I am a ... ?</b></label>
                <select class="form-select mb-5" aria-label="Default select example">
                  ...
                  <label for="Default select example2" style="font-size: large"><b>Field of Project </b></label>
                  <select class="form-select mb-5" aria-label="Default select example2">
                      <option selected hidden>Ex: Computer Software Development</option>
                      <option value="self">Administrative</option>
                      <option value="others">Construction</option>
                      <option value="others">Computer Software Development</option>
                      <option value="others">Design of Plans</option>
                      <option value="others">Equipment or System Installation</option>
                      <option value="others">New Product Development</option>
                      <option value="others">Maintenance of Process Industries</option>
                      <option value="others">Research</option>
                      <option value="others">Others</option>

                  </select>

                  <label for="title" style="font-size: large"><b>What is your fundraiser title?</b></label>
                  <input type="text" id="inputPassword5" placeholder="Ex: Help Stevenson get a new brain" class="form-control" aria-describedby="passwordHelpBlock">
                  ...
                  <div>
                      <a type="submit" href = "{{route('project-step 2')}}" style="font-size:xx-large; color:turquoise; float:right" ><i class="fas fa-arrow-circle-right"></i></a>
                  </div>
