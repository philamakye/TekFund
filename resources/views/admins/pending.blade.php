                    ...
                    <div class="card my-4 mx-3">
                        <div class="card-body">
                            <div class="row align-items-start">
                                ...
                                <div class="progress-bar position"  data-percent="25" data-color="#aadcf5,#12b321"></div>
                                </div>
                 ...
                 @endforeach
                    <div class="card my-4 mx-3">
                        ...
                        <div class="row align-items-start">
                                <div class="col">
                                <h3>Smart Crops</h3>
                                <div class="progress-bar position"  data-percent="60" data-color="#aadcf5,#12b321"></div>
                                </div>
                                <div class="col mt-2 pt-5">
                                  <p>Campaign Starter</p>
                                  <p>Starting date</p>
