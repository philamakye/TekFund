...
<br>
                ...
                Set your fundraising goal
                    ...
                    <input type="number" min="200" oninput="validity.valid||(value='');" name="target" id="inputPassword5" placeholder="Enter Target Amount in GHC" class="form-control" aria-describedby="passwordHelpBlock">
                    <div id="passwordHelpBlock" class="form-text mb-4">
                      ...
                      <input type="number" min="10" oninput="validity.valid||(value='');" name="duration" id="inputPassword5" placeholder="Set Campaign duration in Days" class="form-control" aria-describedby="passwordHelpBlock">
                      <div id="passwordHelpBlock" class="form-text mb-4">
                ...
                Add a Cover Photo Or Video
                    ...
                    <div class="mb-5" style="border-style: dashed">
                        <div class="my-3 px-3 text-center">
                            ...
                            <input class="form-control" type="file" name="cover_img" id="formFile">
                          </div>
                    </div>
                    <div class="container">
                        <div class="row">
           ...
           <label for="title" style="font-size: large; margin:13px"><b>Username of Reference 1</b></label>
           <input oninput="this.className = 'form-control'" name="reference_1" type="text" id="inputPassword5"  class="form-control mb-5" aria-describedby="passwordHelpBlock">

           <label for="title" style="font-size: large; margin:13px"><b>Username of Reference 2</b></label>
           <input oninput="this.className = 'form-control'" name="reference_2" type="text" id="inputPassword5"  class="form-control mb-5" aria-describedby="passwordHelpBlock">
                ...
                <div style="overflow:auto;">
                    <div style="float:right;">
                        ...
                        <button type="submit" style=" background-color:rgb(18, 214, 27); color:white; border:none;float:right; padding:5px;margin-bottom:20px; text-decoration:none; border-radius:7px; margin:15px;" id="submitBtn">Submit Application</button>
                    </div>
